...
st.set_page_config(
    page_title="Agentic Ai - Video Summarizer",
    page_icon="⚽",
    layout="wide"
)

st.title("Video Summarizer  AI_Agent 🤖")
...
video_file = st.file_uploader("Upload a video file", type=["mp4"], help="Upload a video file to summarize")
